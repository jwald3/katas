...
std::vector<int> uniqueElements(std::vector<int> v) {
    ...
    // it moves any duplicated values to the end and points to the start of that "garbage tail"
    // i.e., [1, 2, 2, 3, 3, 3, 4] -> [1, 2, 3, 4, 3, 3, 4] where the new end starts at idx 4
